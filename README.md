...
ChatGPT was used as a supporting tool during the development of the Python code. It was used to help refine the code structure, improve clarity, and assist with troubleshooting. All suggested changes were reviewed and adapted where necessary.
